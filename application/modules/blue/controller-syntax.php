...
class Frontend extends CI_Controller {
    ...
    public function index($url = NULL, $query_str = NULL) {
        ...
        $pods['pages'] = array(array('title' => 'Home Page', 'url' => '/home'), array('title' => 'About Us', 'url' => '/about-us'));
        
        
        // $data['pages'][] = array('title' => 'About Us', 'url' => '/about-us');
         
        $pods['menus'] = array(array('title' => 'Menu Title One', 'url' => '/menu'));
        
        $pods['sidebars'][] = array('title' => 'Sidebars Title One', 'url' => '/sidebars');
        
        // End Joey
        $this->template->set('pods', $pods);
